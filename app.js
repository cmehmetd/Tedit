...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function updateUI() {
    ...
    if (state.activeTool === 'drawing') {
      propTypeBadge.textContent = 'Çizim';
      ...
      if (activeLayer.type === 'text') {
        propTypeBadge.textContent = 'Metin';
        ...
        propTypeBadge.textContent = 'Şekil';
        ...
        propTypeBadge.textContent = 'Görsel';
      } else if (activeLayer.type === 'drawing') {
        propTypeBadge.textContent = 'Çizim Katmanı';
      }
    } else {
      propTypeBadge.textContent = 'Seçim Yok';
